...
st.markdown("""
    ...
    /* --- INPUTS DE DATA (FIX DE CONTRASTE) --- */
    /* Garante legibilidade do texto escuro sobre fundo branco no input */
    ...
    div[data-testid="stMetricValue"] {
        font-size: 22px; color: #1E1E1E; font-weight: 800;
...
if df_limpo is not None:
    ...
    # Header com Logotipo e Título Unificados
    st.sidebar.markdown("""
    <div style="display: flex; align-items: center; gap: 12px; padding-bottom: 20px; border-bottom: 1px solid rgba(255,255,255,0.15); margin-bottom: 25px;">
        <img src="https://img.icons8.com/fluency/48/natural-food.png" width="40">
        <div>
            <h1 style="color: white; font-family: 'Montserrat', sans-serif; font-size: 18px; font-weight: 900; margin: 0; line-height: 1.1;">CENTRAL DE<br>COMANDO</h1>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    data_sel = st.sidebar.date_input("Selecione o Intervalo", [min_date, max_date], label_visibility="collapsed")
